        ...
        execute: function() {
            mockPartidas = (function () {
                function mockPartidas() {
                    ...
                    this.Pregunta2 = new pregunta_model_1.Pregunta(2, "¿En qué año se descubrió America?", "1692", "1492", "2015", "568", 1);
                }
            ...
            exports_1("PARTIDAS", PARTIDAS = [
                new partida_model_1.Partida(1, new mockPartidas().getmockJugadoresPartida(), new mockPartidas().getmockPreguntasPartida(), ["W", "D"], [1, 1], [1, 1], true)
            ]);
